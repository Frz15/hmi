...
public:
    ...
    //显示激光雷达点云marker
    void Display_PointCloud2MarkerArray(bool enable,QString topic);
    //显示毫米波雷达的marker
    void Display_radar2MarkerArray(bool enable,QString topic);
    //显示决策轨迹
    void Display_DecisionTrajectoryPath(bool enable,QString topic);
    //显示导航相关控件
...
private:
    ...
    rviz::Display* pointcloud2MarkerArray_=NULL ;
    rviz::Display* radar2MarkerArray_=NULL ;
    rviz::Display* decisionTrajectoryPath_=NULL ;
