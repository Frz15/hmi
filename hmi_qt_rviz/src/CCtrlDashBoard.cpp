...
void CCtrlDashBoard::drawBackGround(QPainter *painter, qreal hlafWidth)
{
    ...
    startX_=hlafWidth-m_MaxBorderRadius;
    painter->save();
    painter->setPen(m_BorderColor);
    painter->setBrush(m_BorderColor);

    QPainterPath bigCircle;
    bigCircle.addEllipse(startX_, startX_, (m_MaxBorderRadius*2), (m_MaxBorderRadius*2));

    m_MinBorderRadius = m_MaxBorderRadius-20;
    startX_=hlafWidth-m_MinBorderRadius;
    QPainterPath smallCircle;
    smallCircle.addEllipse(startX_, startX_, (m_MinBorderRadius*2), (m_MinBorderRadius*2));
    ...
    painter->drawEllipse(startX_,startX_,(m_MinBorderRadius*2), (m_MinBorderRadius*2));
//    painter->drawText(startX_+90,startX_+170,"M/S");
    painter->restore();
...
void CCtrlDashBoard::drawIndicator(QPainter *painter, qreal hlafWidth)
{
    ...
    QFont font1("Microsoft YaHei", 13, QFont::Bold,true);
    font1.setItalic(false);
    painter->setFont(font1);
    if(m_DashValue==0)
    {
        painter->drawText(startX_+62,startX_+175,QString::number((int)m_DashValue,10) + " km/h");
    }
    else
    {
        painter->drawText(startX_+72,startX_+175,QString::number((int)m_DashValue,10) + " km/h");
    }
    painter->restore();
