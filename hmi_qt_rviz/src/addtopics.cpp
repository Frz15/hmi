...
void AddTopics::initUi()
{
    ...
    QTreeWidgetItem* PointCloud2_status=new QTreeWidgetItem(QStringList()<<"Status");
    PointCloud2_status->setIcon(0,QIcon("://images/ok.png"));
    PointCloud2->addChild(PointCloud2_status);
    PointCloud2_status->setHidden(true);
    QTreeWidgetItem* PointCloud2_Topic=new QTreeWidgetItem(QStringList()<<"Topic");
    PointCloud2->addChild(PointCloud2_Topic);
    PointCloud2_Topic->setHidden(true);
